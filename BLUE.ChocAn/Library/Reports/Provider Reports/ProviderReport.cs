...
namespace BLUE.ChocAn.Library.Reports.Provider_Reports
{
    public class ProviderReport : Report
    {
        ...
        public override string ToString()
        {
            ...
            result += Environment.NewLine + "******************************************";
            result += Environment.NewLine + "BEGIN PROVIDER REPORT";
            ...
            foreach (UserServiceLinker service in this._listOfServices)
            {
                ...
                result += string.Format(Environment.NewLine + "Fee: {0}", thisService.ServiceFee.ToString("C0"));
            ...
            result += string.Format(Environment.NewLine + "Total Fee: {0}", fee.ToString("C0"));
            result += Environment.NewLine + "==========================================";

            result += Environment.NewLine;
            result += Environment.NewLine + "******************************************";
            result += Environment.NewLine + "END PROVIDER REPORT";
            result += Environment.NewLine + "******************************************";
